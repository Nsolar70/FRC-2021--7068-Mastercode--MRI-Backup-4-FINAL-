...
public final class Constants {
    ...
    public static final class SensorContants {
        ...
        public static final int kClimberExtend = 8;

        public static final int kClimberLower = 9;
